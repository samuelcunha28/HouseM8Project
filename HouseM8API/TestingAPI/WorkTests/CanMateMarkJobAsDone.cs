...
namespace HouseM8APITests.WorkTests
{
    ...
    public class CanMateMarkJobAsDone
    {
        private Connection _connection;
        private WorkTestFixture _fixture;

        public CanMateMarkJobAsDone()
        {
        ...
        [Fact]
        public void CanMateMarkJobAsDoneTest()
        {
            ...
            testMate.Email = "DevMIGmlgad@gmail.com";
            ...
            testEmployer.Email = "marceload@gmail.com";
            ...
            Assert.True(workDAO.MarkJobAsDone(returnedJob.Id, returned.Id));
            Assert.Empty(MateDAO.PendingJobsList(returned.Id));
