...
namespace HouseM8APITests.WorkTests
{
    ...
    public class JobNullWhenSendingNonExistentMateId
    {
        private Connection _connection;
        private WorkTestFixture _fixture;

        public JobNullWhenSendingNonExistentMateId()
        {
        ...
        public void JobNullWhenSendingNonExistentMateIdTest()
        {
            ...
            testMate.Email = "DevMIGmlga@gmail.com";
            ...
            testEmployer.Email = "marcelof@gmail.com";
