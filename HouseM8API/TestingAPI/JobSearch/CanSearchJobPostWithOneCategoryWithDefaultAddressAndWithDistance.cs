...
namespace HouseM8APITests.JobSearch
{
    ...
    public class CanSearchJobPostWithOneCategoryWithDefaultAddressAndWithDistance
    {
        ...
        [Fact]
        public void CanSearchJobPostWithOneCategoryWithDefaultAddressAndWithDistanceTest()
        {
            ...
            List<JobPostReturnedModel> jobPosts = jobPostDAO.GetJobs(categories, null, 40, null, 1);
