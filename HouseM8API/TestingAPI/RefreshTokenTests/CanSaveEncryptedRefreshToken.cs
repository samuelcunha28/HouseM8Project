...
namespace HouseM8APITests.WorkTests
{
    ...
    public class CanSaveEncryptedRefreshToken
    {
        private Connection _connection;
        private RefreshTokenTestsFixture _fixture;

        public CanSaveEncryptedRefreshToken()
        {
        ...
        [Fact]
        public void CanSaveEncryptedRefreshTokenTest()
        {
            ...
            bool saved = refreshTokenDAO.saveEncryptedRefreshToken(refreshToken, returned.Email);
