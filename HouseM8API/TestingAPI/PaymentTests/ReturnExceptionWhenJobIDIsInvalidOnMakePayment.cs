...
namespace HouseM8APITests.PaymentTests
{
    ...
    public class ReturnExceptionWhenJobIDIsInvalidOnMakePayment
    {
        ...
        [Fact]
        public void ReturnExceptionWhenJobIDIsInvalidOnMakePaymentTest()
        {
            ...
            testMate.Email = "DevMIGmlgasd@gmail.com";
            ...
            testEmployer.Email = "marceloasd@gmail.com";
            ...
            Assert.Throws<Exception>(() => paymentDAO.makePayment(invoice, 10000000, returnedEmp.Id));
