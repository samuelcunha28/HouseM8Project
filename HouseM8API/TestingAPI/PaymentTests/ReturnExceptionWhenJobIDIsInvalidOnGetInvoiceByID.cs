...
namespace HouseM8APITests.PaymentTests
{
    ...
    public class ReturnExceptionWhenJobIDIsInvalidOnGetInvoiceByID
    {
        private Connection _connection;
        private PaymentTestFixture _fixture;

        public ReturnExceptionWhenJobIDIsInvalidOnGetInvoiceByID()
        {
        ...
        [Fact]
        public void ReturnExceptionWhenJobIDIsInvalidOnGetInvoiceByIDTest()
        {
            ...
            Assert.Throws<Exception>(() => paymentDAO.GetInvoiceByID(returned.Id, 100000000));
