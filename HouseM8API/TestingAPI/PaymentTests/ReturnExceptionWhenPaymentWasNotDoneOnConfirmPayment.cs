...
namespace HouseM8APITests.PaymentTests
{
    ...
    public class ReturnExceptionWhenPaymentWasNotDoneOnConfirmPayment
    {
        ...
        [Fact]
        public void ReturnExceptionWhenPaymentWasNotDoneOnConfirmPaymentTest()
        {
            ...
            Assert.Throws<Exception>(() => paymentDAO.makePayment(invoice, returnedJob.Id, 10000000));
