...
namespace HouseM8APITests.PaymentTests
{
    ...
    public class ReturnExceptionWhenUserIDIsInvalidOnGetInvoiceByID
    {
        ...
        [Fact]
        public void ReturnExceptionWhenUserIDIsInvalidOnGetInvoiceByIDTest()
        {
            ...
            Assert.Throws<Exception>(() => paymentDAO.GetInvoiceByID(1000000, returnedJob.Id));
