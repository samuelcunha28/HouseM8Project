...
namespace HouseM8APITests.PaymentTests
{
    ...
    public class ReturnExceptionWhenPaymentNotAllowedForJob
    {
        ...
        [Fact]
        public void ReturnExceptionWhenPaymentNotAllowedForJobTest()
        {
            ...
            testPost.PaymentMethod = new[] { Payment.PAYPAL, Payment.CRYPTO };
