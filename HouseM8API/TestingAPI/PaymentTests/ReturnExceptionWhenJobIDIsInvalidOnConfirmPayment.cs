...
namespace HouseM8APITests.PaymentTests
{
    ...
    public class ReturnExceptionWhenJobIDIsInvalidOnConfirmPayment
    {
        private Connection _connection;
        private PaymentTestFixture _fixture;

        public ReturnExceptionWhenJobIDIsInvalidOnConfirmPayment()
        {
        ...
        [Fact]
        public void ReturnExceptionWhenJobIDIsInvalidOnConfirmPaymentTest()
        {
            ...
            Assert.Throws<Exception>(() => paymentDAO.confirmPayment(1000000, returned.Id));
