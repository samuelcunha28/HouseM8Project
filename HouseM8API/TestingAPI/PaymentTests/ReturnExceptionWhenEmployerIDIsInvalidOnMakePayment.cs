...
namespace HouseM8APITests.PaymentTests
{
    ...
    public class ReturnExceptionWhenEmployerIDIsInvalidOnMakePayment
    {
        private Connection _connection;
        private PaymentTestFixture _fixture;

        public ReturnExceptionWhenEmployerIDIsInvalidOnMakePayment()
        {
        ...
        [Fact]
        public void ReturnExceptionWhenEmployerIDIsInvalidOnMakePaymentTest()
        {
            ...
            Assert.Throws<Exception>(() => paymentDAO.confirmPayment(returnedJob.Id, returned.Id));
