...
namespace HouseM8APITests.PaymentTests
{
    ...
    public class ReturnExceptionWhenMateIDIsInvalidOnConfirmPayment
    {

        private Connection _connection;
        private PaymentTestFixture _fixture;

        public ReturnExceptionWhenMateIDIsInvalidOnConfirmPayment()
        {
        ...
        [Fact]
        public void ReturnExceptionWhenMateIDIsInvalidOnConfirmPaymentTest()
        {
            ...
            Assert.Throws<Exception>(() => paymentDAO.confirmPayment(returnedJob.Id, 10000000));
