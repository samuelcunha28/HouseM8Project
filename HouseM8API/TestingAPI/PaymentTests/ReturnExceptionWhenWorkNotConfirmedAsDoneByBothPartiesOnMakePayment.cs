...
namespace HouseM8APITests.PaymentTests
{
    ...
    public class ReturnExceptionWhenWorkNotConfirmedAsDoneByBothPartiesOnMakePayment
    {
        private Connection _connection;
        private PaymentTestFixture _fixture;

        public ReturnExceptionWhenWorkNotConfirmedAsDoneByBothPartiesOnMakePayment()
        {
        ...
        [Fact]
        public void ReturnExceptionWhenWorkNotConfirmedAsDoneByBothPartiesOnMakePaymentTest()
        {
