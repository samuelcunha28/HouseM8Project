...
namespace HouseM8APITests.PasswordTests
{
    ...
    public class ReturnExceptionWrongOldPassword
    {
        ...
        [Fact]
        public void ReturnExceptionWrongOldPasswordTest()
        {   
            ...
            newPass.OldPassword = "122";
            
            Assert.Throws<Exception>(() => userDAO.UpdatePassword(newPass, returned.Id));
