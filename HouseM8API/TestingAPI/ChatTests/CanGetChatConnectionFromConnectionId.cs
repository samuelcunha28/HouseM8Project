...
namespace HouseM8APITests.ChatTests
{
    ...
    public class CanGetChatConnectionFromConnectionId
    {
        private Connection _connection;
        private ChatFixture _fixture;

        public CanGetChatConnectionFromConnectionId()
        {
            _fixture = new ChatFixture();
            this._connection = _fixture.GetConnection();
        }
        [Fact]
        public void CanGetChatConnectionFromConnectionIdTest()
        {
            ...
            ChatConnection connection1 = chatDao.GetChatConnectionFromConnectionId("connection1");
            ChatConnection connection2 = chatDao.GetChatConnectionFromConnectionId("connection2");
