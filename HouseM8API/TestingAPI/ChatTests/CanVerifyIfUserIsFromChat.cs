...
namespace HouseM8APITests.ChatTests
{
    ...
    public class CanVerifyIfUserIsFromChat
    {
        private Connection _connection;
        private ChatFixture _fixture;

        public CanVerifyIfUserIsFromChat()
        {
        ...
        [Fact]
        public void CanVerifyIfUserIsFromChatTest()
        {
            ...
            bool user1IsFromChat = chatDao.IsUserFromChat(chatId, returned.Id);
            bool user2IsFromChat = chatDao.IsUserFromChat(chatId, returnedMate.Id);

            Assert.True(user1IsFromChat);
            Assert.True(user2IsFromChat);
