...
namespace HouseM8APITests.ChatTests
{
    ...
    public class CanCreateChatAndGetId
    {
        private Connection _connection;
        private ChatFixture _fixture;

        public CanCreateChatAndGetId()
        {
        ...
        [Fact]
        public void CanCreateChatAndGetIdTest()
        {
            ...
            int? returnedChatId = chatDao.getChatIdWithTargetUser(returned.Id, returnedMate.Id);

            Assert.NotNull(returnedChatId);
